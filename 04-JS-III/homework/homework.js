...
function empiezaConNueve(n) {
  ...
  //Escribe tu código aquí
  let convercion = n.toString();
        for(let i = 0; i <= convercion.length; i++){
                if(convercion[0] === '9') return true;
                return false;
                }
...
function mesesDelAño(array) {
  ...
  // Tu código:
        ...
        if(mesesPerdidos.length < 3) return 'No se encontraron los meses pedidos';
